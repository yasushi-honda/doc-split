...
検索クエリ内の以下3形式を日付トークンとして認識し、書類の `fileDate` と照合する：

| 入力形式 | 例 | 生成トークン |
|---------|----|-------------|
| YYYY年MM月DD日 | `2026年4月27日` | `2026`, `2026-04`, `2026-04-27` |
| YYYY/MM/DD | `2026/04/27` | `2026`, `2026-04`, `2026-04-27` |
| YYYY-MM-DD | `2026-04-27` | `2026`, `2026-04`, `2026-04-27` |
| YYYY年MM月（日なし） | `2026年4月` | `2026`, `2026-04` |
| YYYY/MM（日なし） | `2026/04` | `2026`, `2026-04` |
...
| F27 | 全文検索 | 反転インデックス+TF-IDFによる高速検索（スペース区切りAND段階絞り込み・日付クエリ3形式対応・書類日付降順ソート） | Phase 8 |
