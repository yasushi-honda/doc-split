...
- [ ] I. cocoro本番バックフィル実行 — Hの効果確認後に同様の手順で展開する（H完了後）。**注意**: Issue #660(集計トリガーの非冪等性バグ)がcocoroにも同一コードとして存在する可能性が高い。Iの実施前にIssue #660の影響有無をcocoro側でも確認するか、decision-makerと相談すること
