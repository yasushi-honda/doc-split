...
- [x] 顧客マスター担当ケアマネフィールド追加（CSV・手動・一括上書き対応）**完了 2026-01-25**
- [x] setup-tenant.sh改善（インデックスビルド待機・エイリアス自動追加）**完了 2026-01-25**
- [x] GitHub Pagesドキュメント更新（アップデート配信セクション追加）**完了 2026-01-25**
- [x] Storage CORS設定・巻取りデータ対応 **完了 2026-01-25**
  - Storage CORS設定追加（PDF閲覧に必須）
